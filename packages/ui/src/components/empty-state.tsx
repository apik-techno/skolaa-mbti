...
const EmptyState: React.FC<EmptyStateProps> = ({
  title = 'Kosong',
  description = 'Tidak ada data untuk saat ini',
  onClearFilter,
  onChangeFilter,
}) => {
  return (
    <div className="w-full flex items-center flex-wrap justify-center gap-10">
      <div className="grid gap-4 w-60 py-6">
        <svg
          className="mx-auto"
        ...
        >
          ...
          <path
            ...
            stroke="#ffeefd"
          />
          <circle cx="60.2069" cy="61" r="21.0256" fill="#ffeefd" />
          <path
          ...
          <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style={{ stopColor: '#dc53f1', stopOpacity: 1 }} />
              <stop offset="100%" style={{ stopColor: '#f2aafd', stopOpacity: 1 }} />
            </linearGradient>
          </defs>
          <path
          ...
          <path
            ...
            fill="#dc53f1"
          />
          <rect x="28.9248" y="16.3846" width="30.7692" height="2.05128" rx="1.02564" fill="#dc53f1" />
          <rect x="28.9248" y="100.487" width="41.0256" height="4.10256" rx="2.05128" fill="#dc53f1" />
          <rect x="28.9248" y="22.5385" width="10.2564" height="2.05128" rx="1.02564" fill="#dc53f1" />
          <circle cx="42.2582" cy="23.5641" r="1.02564" fill="#dc53f1" />
          <circle cx="46.3607" cy="23.5641" r="1.02564" fill="#dc53f1" />
          <circle cx="50.4633" cy="23.5641" r="1.02564" fill="#dc53f1" />
        </svg>
        <div>
          <h2 className="text-center text-black text-base font-semibold leading-relaxed pb-1">{title}</h2>
          <p className="text-center text-black text-sm font-normal leading-snug">{description}</p>
          {(onChangeFilter || onClearFilter) && (
