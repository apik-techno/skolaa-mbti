  ...
  return (
    <MenuHeaderWrapper className="nav-header" sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href="/">
          <Image src="/logo/logo-xs.png" width={40} height={40} alt="Logo" />
          <HeaderTitle
            sx={{
              ...menuCollapsedStyles,
          ...
          >
            <Typography variant="subtitle1" className="gothic-a1" sx={{ lineHeight: '1rem', fontWeight: 600 }}>
              {themeConfig.templateName}
            </Typography>
            <Typography
              variant="caption"
              className="gothic-a1"
              sx={{ fontStyle: 'italic', lineHeight: '0.75rem' }}
              fontSize="0.5rem"
            >
