...
export default function StatCard({ title, value, interval, trend, data, start, end }: StatCardProps) {
  const theme = useTheme()
  const defaultStart = subDays(new Date(), 30)
  const defaultEnd = new Date()
  const daysInWeek = getDaysInRange(start || defaultStart, end || defaultEnd)
